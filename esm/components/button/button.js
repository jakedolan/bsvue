...
var computeClass = function computeClass(props) {
  ...
  return ["btn-".concat(props.variant || 'secondary'), (_ref = {}, _defineProperty(_ref, "btn-".concat(props.size), props.size), _defineProperty(_ref, 'btn-block', props.block), _defineProperty(_ref, 'rounded-pill', props.pill), _defineProperty(_ref, 'rounded-0', props.squared && !props.pill), _defineProperty(_ref, "disabled", props.disabled || props.ariaDisabled), _defineProperty(_ref, "active", props.pressed), _ref)];
...
var computeAttrs = function computeAttrs(props, data) {
  ...
  return {
    ...
    'aria-disabled': nonStandardTag ? String(props.disabled) : props.ariaDisabled ? String(props.ariaDisabled) : null,
  ...
  render: function render(h, _ref2) {
    ...
    var on = {
      keydown: function keydown(event) {
        ...
        var keyCode = event.keyCode; // only disable space / enter if aria-disabled
